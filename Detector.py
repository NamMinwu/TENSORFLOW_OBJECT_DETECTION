...
class Detector:
    ...
    def createBoundimgBox(self, image, threshold = 0.5):
        ...
        bboxIdx = tf.image.non_max_suppression(bboxs, classScores, max_output_size=50, iou_threshold=0.5, score_threshold=threshold)
...
###################################################################################################
    ...
    def predictImage(self, imagePath, threshold=0.5):
        ...
        bboxImage = self.createBoundimgBox(image,threshold)
